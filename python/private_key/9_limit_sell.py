...
EOA-based: YES tokens held by EOA. Run 8_split.py first to obtain YES tokens.
...
from py_clob_client_v2.clob_types import OrderArgsV2, PartialCreateOrderOptions, OrderType, OrderPayload, BalanceAllowanceParams, AssetType, BalanceAllowanceParams, AssetType
