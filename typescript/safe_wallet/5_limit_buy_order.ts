...
// ── Step 4: pUSD balance (Safe holds collateral) ──────────────────────────────
...
console.log(`pUSD balance (Safe): $${balance.toFixed(6)}`);

if (balance < 1) { console.error("⚠ Not enough pUSD in Safe — run 3_wrap.ts first."); process.exit(1); }
